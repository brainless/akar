...
**Status:** Research Complete and Verified — Implementation Not Started (Tasks 1-6 researched and re-verified 2026-08-12; implementation Tasks 7-14 are specified and, with the exception of Task 12's manual screen-reader step and Task 14's dependency on 7-12 landing, ready for a coding agent — see "Review — 2026-08-12 verification pass")
...
**Status:** Not Started
**Readiness:** Ready for implementation — no external dependency, no unresolved design question, and all cited anchor points verified current on 2026-08-12. One caveat below on test setup.
...
**Status:** Not Started
**Readiness:** Ready for implementation — checked 2026-08-12 against epics 017 and 018 and no conflict was found (see below). One frame-ordering decision must be made explicitly rather than by accident; both acceptable options are stated below.
...
**Status:** Not Started
**Readiness:** Ready for implementation — with one prerequisite now identified and specified: `akar-layout` needs a new public parent accessor (one function, detailed below). Everything else is verified present.
...
**Status:** Not Started
**Readiness:** Ready for implementation — the dependency-compatibility question that could have blocked this is resolved (verified 2026-08-12, details below). Depends on Tasks 8 and 9 landing first.
...
**Status:** Not Started
**Readiness:** Blocked — partially. The demo *wiring* half is ready for implementation once Task 11 lands. The *announcement verification* half is blocked: nothing in akar's toolchain makes a real VoiceOver/NVDA/Orca announcement machine-readable, so it needs either a human-in-the-loop pass or an `accesskit_consumer`-based harness (Task 13). A coding agent should implement the wiring, then hand the verification step back rather than claiming it as done.
...
**Status:** Not Started
**Readiness:** Ready for implementation once Task 8 exists. The `accesskit_consumer` cross-check is an optional second half and additionally needs Task 11. This task is the practical unblock for Task 12's verification gap.
