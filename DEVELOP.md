...
akar is in **pre-alpha / design phase**. Epic 001 (exploration and architecture) is the active epic. No stable public API exists yet. Architecture decisions are recorded in `epics/` as they are made.
